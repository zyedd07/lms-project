...
const BrandController = __importStar(require("../controllers/brandController")); // Ensure correct import path for the controller
const auth_1 = __importDefault(require("../middleware/auth")); // Assuming isAuth middleware is used for admin authentication
const router = express_1.default.Router();
router.post('/create', auth_1.default, BrandController.createBrandController);
...
router.put('/:id', auth_1.default, BrandController.updateBrandController);
router.delete('/:id', auth_1.default, BrandController.deleteBrandController);
