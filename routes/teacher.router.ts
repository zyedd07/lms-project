...
router.get('/:teacherId/permissions', isAuth, authorizeAdmin, TeacherController.getTeacherPermissions);

// PUT (update) a specific teacher's page permissions
router.put('/:teacherId/permissions', isAuth, authorizeAdmin, TeacherController.updateTeacherPermissions);
