...
router.post('/enroll', isAuth, authorizeAdmin, UserQbankController.enrollInQbank);

// Get all Q-Banks for a specific user
router.get('/user/:userId/qbanks', isAuth, authorizeAdmin, UserQbankController.getUserQbanks);

// Unenroll a user from a Q-Bank
router.delete('/unenroll', isAuth, authorizeAdmin, UserQbankController.unenrollFromQbank);
