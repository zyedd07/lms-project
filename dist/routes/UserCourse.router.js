...
router.post('/enroll', auth_1.default, auth_1.authorizeAdmin, UserCourseController.enrollInCourse);
// Route to get all courses for a specific user
router.get('/user/:userId/courses', auth_1.default, auth_1.authorizeAdmin, UserCourseController.getUserCourses);
// Route to remove a user's enrollment from a course
router.delete('/unenroll', auth_1.default, auth_1.authorizeAdmin, UserCourseController.unenrollFromCourse);
// --- NEW ROUTE ---
