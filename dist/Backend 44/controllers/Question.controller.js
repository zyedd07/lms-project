...
const createQuestionController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { testId, questionType = 'mcq', questionText, questionImageUrl, options, correctAnswerIndex, pairs, points, negativePoints, answerDescription, } = req.body;
...
const updateQuestionController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.user.role !== constants_1.Role.ADMIN && req.user.role !== constants_1.Role.TEACHER)
            throw new httpError_1.default("Unauthorized", 403);
        const { id } = req.params;
        const { questionType, questionText, questionImageUrl, options, correctAnswerIndex, pairs, points, negativePoints, answerDescription, } = req.body;
