...
exports.getTestRankingsController = exports.getUserStatisticsController = exports.deleteResultController = exports.getAllResultsController = exports.getResultsByTestController = exports.getMyResultsController = exports.getResultsByUserController = exports.getResultByIdController = exports.createResultController = void 0;
...
const getTestRankingsController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { testId } = req.params;
        // Students can see rankings, but only after the test window closes (optional guard)
        // Admins/Teachers always see it
        const rankings = yield (0, Result_service_1.getTestRankingsService)(testId);
...
exports.getTestRankingsController = getTestRankingsController;
