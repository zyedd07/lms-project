...
exports.updateTeacherPermissions = exports.getTeacherPermissions = void 0;
const TeacherService = __importStar(require("../services/teacher.service"));
const getTeacherPermissions = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { teacherId } = req.params;
        const permissions = yield TeacherService.getTeacherPermissions({ teacherId });
...
const updateTeacherPermissions = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { teacherId } = req.params;
        ...
        const updatedTeacher = yield TeacherService.updateTeacherPermissions({ teacherId, permissions });
